...
import org.azuremd.backend.test.Azure;
 ...
 * 
 */
@WebServiceClient(name = "AzureService", targetNamespace = "http://webservice.backend.azuremd.org/", wsdlLocation = "http://localhost:8080/services?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://localhost:8080/services?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://localhost:8080/services?wsdl', retrying as a local file");
